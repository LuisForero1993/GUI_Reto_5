...
public class ProyectoDao {
    ...
    public List<ProyectoVo> listarProyectos(String clasificacion1, String clasificacion2) throws SQLException{
        List<ProyectoVo> respuesta = new ArrayList<>();
